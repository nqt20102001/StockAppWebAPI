...
# Tạo 10,000 bản ghi và chèn vào bảng quotes
quotes_data = []
for _ in range(10000):
    stock_id = random.choice(stock_ids)  # Chọn ngẫu nhiên stock_id từ danh sách
...
# Chèn dữ liệu vào bảng quotes
db.cursor.executemany(insert_query, quotes_data)

# Commit thay đổi
db.conn.commit()

print("Chèn 10,000 bản ghi vào bảng quotes thành công.")
